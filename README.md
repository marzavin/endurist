...
- **Open Source License:**  
  The source code of this project is available under the **GNU Affero General Public License v3 (AGPL-3.0)**.  
  You may use, modify, and distribute the code for **personal, educational, or non-commercial purposes**,  
  provided that any modified versions or services built upon it are also made available under the AGPL license.
